...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* <div className="bg-[#ffd6f2] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#000]"></div>
        ...
        <div className="bg-[#CDECFF] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#000]"></div>
